...
class TatakiSensor{
    ...
    // データの送信
    sendData(){
        let kindsSumaho = document.getElementById('kindsSumaho').value;
        console.log(kindsSumaho);

        let kindsTataki = document.getElementById('kindsTataki').value;
        console.log(kindsTataki);
        ...
        let data = {
            ...
            'orientation':tatakiSettings.deviceOrientation,
            'kindsSumaho':kindsSumaho,
            'kindsTataki':kindsTataki
        };
        // Fetch APIでデータ送信
        fetch('/collectAPI', {　 // 送信先URL
            method: 'post', // 通信メソッド
            headers: {
